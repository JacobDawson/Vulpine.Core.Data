...
namespace Vulpine.Core.Data
{
    ...
    /// data to one another, allowing complex data structors to be built. Each
    /// node will contain a single piece of data and zero, one, or more refrences
    /// to other nodes. The nodes refrenced by a given node are refred to as that
